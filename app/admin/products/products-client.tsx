...
import { togglePublishAction, updateStockAction, deleteProductAction, saveProductAction } from "./actions";
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="font-display text-4xl font-semibold tracking-tight">Products</h1>
          <p className="mt-2 text-brand-muted dark:text-white/60">Manage catalog, publish status, and inventory.</p>
        </div>
        <button
